...
public class MovieStackWidget extends AppWidgetProvider {
    public static final String UPDATE_WIDGET = "com.coding.wk.UPDATE_WIDGET";
    public static final String TOAST_ACTION = "com.coding.wk.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.coding.wk.EXTRA_ITEM";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(TOAST_ACTION)) {
            ...
            int[] idsWidget = appWidgetManager.getAppWidgetIds( new ComponentName(context, MovieStackWidget.class));
            appWidgetManager.notifyAppWidgetViewDataChanged(idsWidget, R.id.stack_view);
        }
